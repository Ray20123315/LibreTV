...
function renderDoubanCards(data, container) {
    ...
    // 你的專屬圖片代理網址
    const MY_IMAGE_PROXY = "https://my-proxy.ray20123315.workers.dev/?url=";
    ...
    if (!data.subjects || data.subjects.length === 0) {
        ...
        data.subjects.forEach(item => {
            ...
            // --- 核心修改開始：只讓圖片網址走代理 ---
            // 直接強制所有封面網址通過你的 Worker 加載，避開豆瓣的 418 阻擋
            const proxiedCoverUrl = MY_IMAGE_PROXY + encodeURIComponent(item.cover);
            // --- 核心修改結束 ---
            ...
            card.innerHTML = `
                <div class="relative w-full aspect-[2/3] overflow-hidden cursor-pointer" onclick="fillAndSearchWithDouban('${safeTitle}')">
                    <img src="${proxiedCoverUrl}" alt="${safeTitle}" 
                        ...
                        onerror="this.onerror=null; this.src='https://via.placeholder.com/200x300?text=圖片失效';"
